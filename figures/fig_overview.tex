...
\tikzset{
  ...
  stp/.style   ={draw=ink,line width=.5pt,rounded corners=2pt,fill=white,align=center,font=\scriptsize,inner sep=4pt,text=ink,minimum width=56mm},
...
\begin{scope}[on background layer]
  \node[netbox,fit=(s1)(s2)(s3)(s4),inner sep=6pt,label={[net,font=\scriptsize\bfseries]above:SINGLE LEARNED NETWORK, one forward pass, no hand graph}] (net) {};
\end{scope}
% 3. Pi_theta
...
\draw[main] (net.east|-pi.west) -- (pi.west) node[pos=0.5,above,slbl,align=center]{pose,\\wall/ortho};
\draw[main] (pi.east) -- (12.2,0.05);
% capacity
