...
\end{scope}
% 3. Pi_theta
\node[prjbox,minimum width=18mm] (pi) at (9.9,0.05) {\textbf{\textcolor{prj}{$\Pi_\theta$}}\\ differentiable\\ projection\\ {\tiny\color{mut} the \emph{only}}\\ {\tiny\color{mut} non-learned step}};
\begin{scope}[shift={(9.35,1.5)},scale=0.55]
...
\end{scope}
% 4. OUTPUT
\draw[wall] (11.55,-0.65)--(12.75,-0.65)--(12.75,0.3)--(12.15,0.6)--(11.55,0.3)--cycle;
\furn{11.7}{-0.5}{0.35}{0.55}{net!55}\furn{12.2}{-0.45}{0.4}{0.3}{prj!55}
\node[lbl,below] at (12.15,-0.75) {output $S_\text{tgt}$};
% arrows
\draw[main] (1.55,0.65) -- (net.west|-{(0,0.65)});
\draw[main] (net.east) -- (pi.west) node[pos=0.32,above,slbl]{pose, wall/ortho};
\draw[main] (pi.east) -- (11.5,0.0);
% capacity
\node[draw=mut!40,fill=mut!6,rounded corners=3pt,align=center,font=\scriptsize,inner sep=5pt,text=ink,minimum width=124mm] (cap) at (6.0,-2.55) {\textbf{\textcolor{mut}{Capacity adaptation}}\quad shrink $\to$ existence head drops $+$ smaller-asset substitution \quad$\vert$\quad grow $\to$ density-budgeted upsize $+$ learned population};
\end{tikzpicture}
\end{document}
